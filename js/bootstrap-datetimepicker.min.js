...
(function (a) {
    ...
    i.prototype = {
        constructor: i, _events: [], _attachEvents: function () {
            ...
            var currentDay = new Date().getUTCDate() + 1;
            while (K.valueOf() < j) {
                ...
                if (K.getUTCMonth()+1 < currentmonth  && (K.getUTCFullYear()<=currentyear) ){
                    s.push('<td class="day notWorkingDay' + v + '">' + K.getUTCDate() + "</td>");
                }
                else if ((K.getUTCDate() < currentDay-1) && (K.getUTCMonth()+1 <= currentmonth) && (K.getUTCFullYear()<=currentyear) )
                    s.push('<td class="day notWorkingDay' + v + '">' + K.getUTCDate() + "</td>");
                else
